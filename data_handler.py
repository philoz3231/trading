...
class DataHandler():
    def __init__(self):
        #self.conn = mdb.connect('221.147.129.137', 'james', 'mhrinc01', 'stock', port=63306, charset='utf8');
        self.conn = mdb.connect('localhost', 'root', 'root', 'stock', port=3306, charset='utf8')
